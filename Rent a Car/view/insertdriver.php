...
<input type="text" name="ime" class="form-control" placeholder="Unesite ime vozaca">
<?php if(array_key_exists('ime',$errors)){
    echo $errors['ime'];
}?>
<br><br>
<input type="text" name="prezime" class="form-control" placeholder="Unesite prezime vozaca">
<?php if(array_key_exists('prezime',$errors)){
    echo $errors['prezime'];
}?>
<br><br>
<input type="number" name="godiste" class="form-control" placeholder="Unesite godiste vozaca">
<?php if(array_key_exists('godiste',$errors)){
    echo $errors['godiste'];
}?>
<br><br>
<input type="submit" name="page" class="btn btn-primary" value="Insert driver">
</form>
<br>
<?php
